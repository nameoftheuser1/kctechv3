<x-admin-layout>
    <div class="container mx-auto px-4 py-8 w-full sm:w-1/2 border rounded-lg bg-white mt-0 sm:mt-10">
        ...
        <p class="text-sm text-slate-500 mb-6">Update room details</p>
        <form action="{{ route('rooms.update', $room) }}" method="POST" class="flex flex-col w-full justify-center">
            ...
            <div class="mb-4 w-full">
                ...
                <input type="text" name="room_number" id="room_number"
                    ...
                    placeholder="Room - 1" value="{{ old('room_number', $room->room_number) }}" required>
            </div>
            ...
            <div class="mb-4 w-full">
                ...
                <input type="text" name="room_type" id="room_type"
                    class="w-full text-gray-600 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                    placeholder="e.g. Deluxe Suite" value="{{ old('room_type', $room->room_type) }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="price" id="price" step="0.01"
                    class="w-full text-gray-600 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                    placeholder="0.0" value="{{ old('price', $room->price) }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="pax" id="pax"
                    class="w-full text-gray-600 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                    placeholder="5" value="{{ old('pax', $room->pax) }}" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="stay_type" id="stay_type"
                    ...
                    <option value="day tour" {{ (old('stay_type', $room->stay_type) == 'day tour') ? 'selected' : '' }}>Day Tour</option>
                    <option value="overnight" {{ (old('stay_type', $room->stay_type) == 'overnight') ? 'selected' : '' }}>Overnight</option>
                </select>
            </div>
